...
public class Task2_7 {
    ...
    public static void main(String[] args) {
       ...
       // ② ①で作成した配列の要素数を出力して下さい。
        System.out.println("country配列の要素数:" + country.length);
       ...
       // ④ ③で作成した配列の3番目の要素を出力しなさい。
        System.out.println("strArray配列の3番目の要素:" + strArray[2]);

        /* ⑤下記の処理について、何をしているのかコメントを記入して下さい。
        *  [int型の配列intArrayを作成して{10,20,30,40,50}で宣言と初期化をしている]
        */
        int[] intArray = { 10, 20, 30, 40, 50 };


       // ⑥下記の処理について、何をしているのかコメントを記入して下さい。
       // [intArrayの1番目と5番目の要素を出力している]
